...
// W RN do FormData wrzucamy obiekt {uri, name, type} (nie 'File' jak w przegladarce).
// Akceptujemy wiec 'any', a wywolujacy buduje FormData lokalnie.
export const attachmentsApi = {
  upload: (taskId: string, formData: FormData) => {
    return apiClient.post<AttachmentDto>(`/api/tasks/${taskId}/attachments`, formData, {
